	...
	<div class="col-lg-4 offset-lg-4 col-md-8 offset-md-2 col-12">
		<div class="login-form">
			...
			<div class="card-footer" style="border: none">
				<button type="submit" class="btn btn-primary w-100 border-content">{_LANG_277} <em class="fa fa-chevron-right"></em></button>
				...
				<!-- ENDIF -->
				<p class="text-center text-secondary mt-2">lub</p>
				<a href="{SITEURL}/funcs.php?name=user&amp;file=register" class="btn btn-application w-100">Zarejestruj się</a>
			</div>
		</div>
	</div>
</form>
