...
class template
{
	...
	*/
	function set_template()
	{
		...
		$admindir = (defined('ADMIN_PANEL')) ? dirname(__FILE__).'/../theme/admin' : dirname(__FILE__).'/../theme';
		$admincache = (!defined('ADMIN_PANEL')) ? dirname(__FILE__).'/../cache/tpl_' . str_replace('_', '-', 'theme') : dirname(__FILE__).'/../theme/admin';

		if (file_exists($admindir))
		{
			$this->root = $admindir;
			$this->cachepath = $admincache . '_';
			$this->default_root = $admindir;
			$this->default_cachepath = $admincache . '_';
		}
		else
		{
			trigger_error('Template path could not be found: ' . $admindir, E_USER_ERROR);
		}
	...
	*/
	function _tpl_load(&$handle)
	{
		...
		{
			include 'inc/classes/class.tpl.php';
		}
